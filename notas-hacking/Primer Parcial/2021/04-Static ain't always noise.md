...
- El desafío nos da un enlace para descargar un script ltdis.sh y un archivo ejecutable binario static:
``` bash 
┌──(kali㉿kali)-[~/Descargas]
└─$ ls           
ltdis.sh
...
static:     formato del fichero elf64-x86-64
...
- Se realiza el desensamblaje de los dos archivos descargados.
- Suponiendo que la bandera puede haber sido una cadena estática en el binario, vemos lo que hay dentro del archivo "static.ltdis.strings.txt" seguido de un grep para obtener la bandera. 
