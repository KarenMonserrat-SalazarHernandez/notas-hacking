...
- Como el rango combinado de hex-ascii para alfabetos ingleses y dígitos numéricos es de 30 a 7A 
- Entoces:  inicia 0x0000000000001184 <+27>:    movb   $0x70,-0x30(%rbp) y termina en  0x0000000000001200 <+151>:   movzbl -0x30(%rbp),%eax
...
- Con ayuda de un conversor obtenemos la bandera.
